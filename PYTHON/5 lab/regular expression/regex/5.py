...
pattern = r"^.*\.ab$"  # Кез келген символдар болуы мүмкін, бірақ соңында ".ab" болуы шарт

test_strings = ["hello.ab", "test.ab", "word.ab.ab", "nothing", "example.ab", "wrong.abcd"]

for s in test_strings:
    match = re.match(pattern, s)  # re.match() жолдың басынан тексереді
